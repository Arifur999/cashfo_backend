...
// ReceivablesPayablesModule for Contact.currentBalance (Prompt 9), and
// UploadsModule for ImgbbService (the photo-upload route). All
...
@Module({
  imports: [TransactionsModule, ReceivablesPayablesModule, UploadsModule],
